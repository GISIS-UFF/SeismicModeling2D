...
@jit(nopython=True, parallel=True)
def updatePsi(PsixFR, PsixFL, PsizFU, PsizFD, nx_abc, nz_abc, a_x,a_z, b_x, b_z, Uc, dx,dz, N_abc):
...
@jit(nopython=True, parallel=True)
def updateZeta(PsixFR, PsixFL, ZetaxFR, ZetaxFL,PsizFU, PsizFD, ZetazFU, ZetazFD, nx_abc, nz_abc, a_x,a_z, b_x,b_z, Uc, dx, dz, N_abc):
...
@jit(nopython=True, parallel=True)
def updateWaveEquationTTICPML(Uf, Uc, Qc, Qf, nx_abc, nz_abc, dt, dx, dz, vpz, vsz, epsilon, delta, theta, PsixFR, PsixFL,PsizFU, PsizFD,PsixqFR, PsixqFL,PsizqFU, PsizqFD,ZetaxFR, ZetaxFL,ZetazFU, ZetazFD,ZetaxzFU, ZetaxzFD,ZetaxqFL, ZetaxqFR,ZetazqFU, ZetazqFD,ZetaxzqFU, ZetaxzqFD, N_abc):
    c0 = -205. / 72.
    c1 = 8. / 5.
    c2 = -1. / 5.
    c3 = 8. / 315.
    ...
    for i in prange(4, N_abc):
        for j in prange(N_abc, nz_abc - N_abc):
            ...
            psiqx = (a1 * (PsixqFL[j, i+1] - PsixqFL[j, i-1]) +
                    ...
                    a4 * (PsixqFL[j, i+4] - PsixqFL[j, i-4])) / (2*dx)       
            psizxU = (a1 * (PsizFU[j, i+1] - PsizFU[j, i-1]) +
                    a2 * (PsizFU[j, i+2] - PsizFU[j, i-2]) +
                    a3 * (PsizFU[j, i+3] - PsizFU[j, i-3]) +
                    a4 * (PsizFU[j, i+4] - PsizFU[j, i-4])) / (2*dx)  
            psizxD = (a1 * (PsizFD[j, i+1] - PsizFD[j, i-1]) +
                    a2 * (PsizFD[j, i+2] - PsizFD[j, i-2]) +
                    a3 * (PsizFD[j, i+3] - PsizFD[j, i-3]) +
                    a4 * (PsizFD[j, i+4] - PsizFD[j, i-4])) / (2*dx)       
            psiqzxU = (a1 * (PsizqFU[j, i+1] - PsizqFU[j, i-1]) +
                    a2 * (PsizqFU[j, i+2] - PsizqFU[j, i-2]) +
                    a3 * (PsizqFU[j, i+3] - PsizqFU[j, i-3]) +
                    a4 * (PsizqFU[j, i+4] - PsizqFU[j, i-4])) / (2*dx)
            psiqzxD = (a1 * (PsizqFD[j, i+1] - PsizqFD[j, i-1]) +
                    a2 * (PsizqFD[j, i+2] - PsizqFD[j, i-2]) +
                    a3 * (PsizqFD[j, i+3] - PsizqFD[j, i-3]) +
                    a4 * (PsizqFD[j, i+4] - PsizqFD[j, i-4])) / (2*dx)
            
            Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFL[j, i]) + cpz * pzz + cpxz * (pxz + psizxD + psizxU + ZetaxzFUL[j,i] + ZetaxzFDL[j,i]) + dpx * (qxx + psiqx + ZetaxqFL[j, i]) + dpz * qzz + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFUL[j,i] + ZetaxzqFDL[j,i]))
            Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFL[j, i]) + cqz * pzz + cqxz * (pxz + psizxD + psizxU + ZetaxzFUL[j,i] + ZetaxzFDL[j,i]) + dqx * (qxx + psiqx + ZetaxqFL[j, i]) + dqz * qzz  + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFUL[j,i] + ZetaxzqFDL[j,i]))
    ...
    #                 a4 * (PsixqFR[j, idx+4] - PsixqFR[j, idx-4])) / (2*dx)
    #         psiqzxU = (a1 * (PsizqFU[j, i+1] - PsizqFU[j, i-1]) +
    #                 a2 * (PsizqFU[j, i+2] - PsizqFU[j, i-2]) +
    #                 a3 * (PsizqFU[j, i+3] - PsizqFU[j, i-3]) +
    #                 a4 * (PsizqFU[j, i+4] - PsizqFU[j, i-4])) / (2*dx)
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFR[j, idx]) + cpz * pzz + cpxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[j,idx]) + dpx * (qxx + psiqx + ZetaxqFR[j, idx]) + dpz * qzz + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[j,idx]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFR[j, idx]) + cqz * pzz + cqxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[j,idx]) + dqx * (qxx + psiqx + ZetaxqFR[j, idx]) + dqz * qzz  + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[j,idx]))
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * pxx + cpz * (pzz + psiz + ZetazFU[j, i]) + cpxz * (pxz + psizxU + ZetaxzFU[j,i]) + dpx * qxx  + dpz * (qzz + psiqz + ZetazqFU[j,i]) + dpxz * (qxz + psiqzxU + ZetaxzqFU[j,i]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * pxx + cqz * (pzz + psiz + ZetazFU[j, i]) + cqxz * (pxz + psizxU + ZetaxzFU[j,i]) + dqx * qxx  + dqz * (qzz + psiqz + ZetazqFU[j,i]) + dqxz * (qxz + psiqzxU + ZetaxzqFU[j,i]))
    ...
    #                 a4 * (PsizFD[jdx, i+4] - PsizFD[jdx, i-4])) / (2*dx)    
    ...
    #                 a4 * (PsizqFD[jdx, i+4] - PsizqFD[jdx, i-4])) / (2*dx)
            
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * pxx + cpz * (pzz + psiz + ZetazFD[jdx, i]) + cpxz * (pxz + psizxD + ZetaxzFD[jdx,i]) + dpx * qxx  + dpz * (qzz + psiqz + ZetazqFD[jdx,i]) + dpxz * (qxz + psiqzxD + ZetaxzqFD[j,i]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * pxx + cqz * (pzz + psiz + ZetazFD[jdx, i]) + cqxz * (pxz + psizxD + ZetaxzFD[jdx,i]) + dqx * qxx  + dqz * (qzz + psiqz + ZetazqFD[jdx,i]) + dqxz * (qxz + psiqzxD + ZetaxzqFD[j,i]))
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFL[j, i]) + cpz * (pzz + psiz + ZetazFU[j, i]) + cpxz * (pxz + psizxD + psizxU + ZetaxzFU[j,i] + ZetaxzFD[j,i]) + dpx * (qxx + psiqx + ZetaxqFL[j, i]) + dpz * (qzz + psiqz + ZetazqFU[j,i]) + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,i] + ZetaxzqFD[j,i]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFL[j, i]) + cqz * (pzz + psiz + ZetazFU[j, i]) + cqxz * (pxz + psizxD + psizxU + ZetaxzFU[j,i] + ZetaxzFD[j,i]) + dqx * (qxx + psiqx + ZetaxqFL[j, i])  + dqz * (qzz + psiqz + ZetazqFU[j,i]) + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,i] + ZetaxzqFD[j,i]))
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFR[j, idx]) + cpz * (pzz + psiz + ZetazFU[j, i]) + cpxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[j,idx]) + dpx * (qxx + psiqx + ZetaxqFR[j, idx]) + dpz * (qzz + psiqz + ZetazqFU[j,i]) + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[j,idx]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFR[j, idx]) + cqz * (pzz + psiz + ZetazFU[j, i]) + cqxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[j,idx]) + dqx * (qxx + psiqx + ZetaxqFR[j, idx])  + dqz * (qzz + psiqz + ZetazqFU[j,i]) + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[j,idx]))
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFL[j, i]) + cpz * (pzz + psiz + ZetazFD[jdx, i]) + cpxz * (pxz + psizxD + psizxU + ZetaxzFU[j,i] + ZetaxzFD[jdx,i]) + dpx * (qxx + psiqx + ZetaxqFL[j, i]) + dpz * (qzz + psiqz + ZetazqFD[jdx,i]) + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,i] + ZetaxzqFD[jdx,i]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFL[j, i]) + cqz * (pzz + psiz + ZetazFD[jdx, i]) + cqxz * (pxz + psizxD + psizxU + ZetaxzFU[j,i] + ZetaxzFD[jdx,i]) + dqx * (qxx + psiqx + ZetaxqFL[j, i])  + dqz * (qzz + psiqz + ZetazqFD[jdx,i]) + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,i] + ZetaxzqFD[jdx,i]))
    ...
    #         Uf[j, i] = 2 * Uc[j, i] - Uf[j, i] + (dt**2) * (cpx * (pxx + psix + ZetaxFR[j, idx]) + cpz * (pzz + psiz + ZetazFD[jdx, idx]) + cpxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[jdx,idx]) + dpx * (qxx + psiqx + ZetaxqFR[j, idx]) + dpz * (qzz + psiqz + ZetazqFD[jdx,idx]) + dpxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[jdx,idx]))
    #         Qf[j, i] = 2 * Qc[j, i] - Qf[j, i] + (dt**2) * (cqx * (pxx + psix + ZetaxFR[j, idx]) + cqz * (pzz + psiz + ZetazFD[jdx, idx]) + cqxz * (pxz + psizxD + psizxU + ZetaxzFU[j,idx] + ZetaxzFD[jdx,idx]) + dqx * (qxx + psiqx + ZetaxqFR[j, idx]) + dqz * (qzz + psiqz + ZetazqFD[jdx,idx]) + dqxz * (qxz + psiqzxU + psiqzxD + ZetaxzqFU[j,idx] + ZetaxzqFD[jdx,idx]))
...
def updateZetaTTI(PsixqFR, PsixqFL, PsizFU, PsizFD, PsizqFU, PsizqFD, ZetaxqFL, ZetaxqFR, ZetaxzFUL,ZetaxzFUR, ZetaxzFDL, ZetaxzFDR, ZetaxzqFUL, ZetaxzqFUR, ZetaxzqFDL, ZetaxzqFDR, nx_abc, nz_abc, a_x, b_x, Qc, Uc, dx, dz, N_abc):
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            psizx = (a1 * (PsizFU[jdx, i+1] - PsizFU[jdx, i-1]) +
                a2 * (PsizFU[jdx, i+2] - PsizFU[jdx, i-2]) +
                a3 * (PsizFU[jdx, i+3] - PsizFU[jdx, i-3]) +
                a4 * (PsizFU[jdx, i+4] - PsizFU[jdx, i-4])) / (2*dx)
           
            ZetaxzFUL[j, idx] = a_x[idx] * ZetaxzFUL[j, idx] + b_x[idx] * (pxz + psizx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzFUR[j, idx] = a_x[idx] * ZetaxzFUR[j, idx] + b_x[idx] * (pxz + psizx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzFDL[j, idx] = a_x[idx] * ZetaxzFDL[j, idx] + b_x[idx] * (pxz + psizx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzFDR[j, idx] = a_x[idx] * ZetaxzFDR[j, idx] + b_x[idx] * (pxz + psizx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            psiqzx = (a1 * (PsizqFU[jdx, i+1] - PsizqFU[jdx, i-1]) +
                a2 * (PsizqFU[jdx, i+2] - PsizqFU[jdx, i-2]) +
                a3 * (PsizqFU[jdx, i+3] - PsizqFU[jdx, i-3]) +
                a4 * (PsizqFU[jdx, i+4] - PsizqFU[jdx, i-4])) / (2*dx)

            ZetaxzqFUL[j, idx] = a_x[idx] * ZetaxzqFUL[j, idx] + b_x[idx] * (qxz + psiqzx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzqFUR[j, idx] = a_x[idx] * ZetaxzqFUR[j, idx] + b_x[idx] * (qxz + psiqzx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzqFDL[j, idx] = a_x[idx] * ZetaxzqFDL[j, idx] + b_x[idx] * (qxz + psiqzx)
    ...
    for i in prange(4, nx_abc - 4):
        ...
        for j in prange(4, nz_abc - 4):
            ...
            ZetaxzqFDR[j, idx] = a_x[idx] * ZetaxzqFDR[j, idx] + b_x[idx] * (qxz + psiqzx)
