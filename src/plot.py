...
plt.viewModel(f"fwi_vp_acoustic_Nx201_Nz201_itr5.bin")
...
# plt.viewSeismogram(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/seismograms/seismogram_obs_shot_3_Nt8001_Nrec300.bin", perc=99)
...
plt.viewImage(f"../outputs/migrated_image/gradient_fwi_iter_5_acoustic_Nx201_Nz201.bin",laplacian=False,perc=99)
...
model = np.fromfile("../inputs/fwi_vp_acoustic_Nx201_Nz201_itr5.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
