...
snap = np.fromfile("../outputs/snapshots/acousticcerjan_shot_1_Nx301_Nz301_Nt8001_frame_1200forward.bin", dtype=np.float32).reshape(nz, nx)
snapcheck = np.fromfile("../outputs/snapshots/acousticcerjan_shot_1_Nx301_Nz301_Nt8001_frame_1200checkpoint.bin", dtype=np.float32).reshape(nz, nx)
# snapSB = np.fromfile("../outputs/snapshots/acousticcerjan_shot_1_Nx301_Nz301_Nt8001_frame_6800SB.bin", dtype=np.float32).reshape(nz, nx)
