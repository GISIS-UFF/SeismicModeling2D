...
plt.viewModel(f"fwi_vp_acoustic_Nx201_Nz201_itr2.bin")
...
plt.viewImage(f"../outputs/images/gradient_fwi_iter_2_acoustic_Nx201_Nz201.bin",laplacian=False,perc=100)
