...
# plt.viewSourceWavelet()
# plt.viewModel("layer2vp_Nz301_Nx301.bin")
# plt.viewSnapshot("acoustic_shot_1_Nx301_Nz101_Nt4001_frame_1200.bin", "../inputs/layeredvp_Nz101_Nx301.bin")
# plt.movieSnapshot("acoustic_shot_1_Nx301_Nz301_Nt8001_frame_", "../inputs/layer2vp_Nz301_Nx301.bin", savegif = False)
...
plt.viewMigratedImage("../outputs/migrated_image/migrated_image_acoustic_Nx301_Nz301.bin",laplacian=True,perc=99)