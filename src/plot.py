...
plt.viewModel(f"/home/processamento/SeismicModeling2D/inputs/models/ExpandWatervp_Nz396_Nx851.bin")
# plt.viewHistory()
...
# plt.viewSeismogram(f"/home/processamento/SeismicModeling2D/outputs/seismograms/seismogram_shot_5_Nt8001_Nrec170.bin", perc=99)
...
plt.viewImage(f"../outputs/images/migrated_image_acoustic_Nx851_Nz396.bin",laplacian=True,perc=98)
...
# model_smooth = np.fromfile("/home/processamento/SeismicModeling2D/inputs/models/fwi_vp_smooth_acoustic_Nx851_Nz351.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
# model_ref = np.fromfile("/home/processamento/SeismicModeling2D/inputs/models/vp_marmousi-ii_dh10m_Nz351_Nx851.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
# model_fwi = np.fromfile("/home/processamento/SeismicModeling2D/inputs/models/fwi_vp_acoustic_Nx851_Nz351_itr25.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
