...
plt.viewModel("diffractorvp_Nz201_Nx301.bin")
...
plt.viewSeismogram("../outputs/seismograms/CPML_seismogram_shot_1_Nt4001_Nrec501.bin", perc=95)
...
plt.viewMigratedImage("../outputs/migrated_image/migrated_image_acoustic_Nx301_Nz201.bin",perc=99)
