...
plt.viewModel(f"../outputs/estimated_models/fwi_vp_VTI_Nx751_Nz451_itr12_freq15.0.bin")
# plt.viewHistory()
...
# plt.viewSeismogram(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/seismograms/residual_shot_15_Nt5001_Nrec170.bin", perc=99)
...
plt.viewImage(f"../outputs/gradients/gradient_fwi_iter_13_VTI_Nx751_Nz451_freq15.0.bin",laplacian=True,perc=98)
...
model_smooth = np.fromfile("/home/juanmarques/workspace/SeismicModeling2D/inputs/models/fwi_vp_smooth_acoustic_Nx751_Nz451.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
model_ref = np.fromfile("/home/juanmarques/workspace/SeismicModeling2D/inputs/models/bptti2007/Vp_Model_shape_(1801, 12596)_dh25m_Nz451_Nx751.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
model_fwi = np.fromfile("../outputs/estimated_models/fwi_vp_VTI_Nx751_Nz451_itr12_freq15.0.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
