...
plt.viewModel(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/estimated_models/fwi_vp_acoustic_Nx681_Nz141_itr20.bin")
plt.viewHistory()
...
# plt.viewImage(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/gradients/gradient_fwi_iter_16_acoustic_Nx681_Nz141.bin",laplacian=True,perc=99)
...
model_fwi = np.fromfile("/home/juanmarques/workspace/SeismicModeling2D/outputs/estimated_models/fwi_vp_acoustic_Nx681_Nz141_itr20.bin", dtype=np.float32).reshape(pmt.nz,pmt.nx)
