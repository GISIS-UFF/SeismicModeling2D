...
# plt.viewModel(f"vp_marmousi-ii_shape_(2801, 13601)_dh10m_Nz351_Nx1701.bin")
...
# plt.viewSeismogram(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/seismograms/seismogram_shot_20_Nt8001_Nrec1400.bin", perc=99)
...
plt.viewImage(f"../outputs/images/migrated_image_acoustic_Nx1701_Nz351.bin",laplacian=False,perc=100)
