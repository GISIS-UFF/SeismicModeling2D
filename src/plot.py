...
# plt.viewModel(f"../inputs/models/ExpandWatervp_Nz396_Nx851.bin")
# plt.viewHistory()
...
# plt.viewSeismogram(f"/home/juanmarques/workspace/SeismicModeling2D/outputs/seismograms/seismogram_shot_10_Nt8001_Nrec170.bin", perc=99)
