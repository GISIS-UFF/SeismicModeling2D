...
muted_seismogram = Mute(seismogram, shot, pmt.rec_x, pmt.rec_z, pmt.shot_x, pmt.shot_z, pmt.dt, shift = 0.17,window = 0.1,v0=1500)

plt.figure()
plt.plot(seismogram[:,250], label = "seismogram")
plt.plot(muted_seismogram[:,250], label = "muted")
plt.legend()
plt.figure()
