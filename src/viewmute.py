...
shot = 0
seismogramFile = f"{pmt.seismogramFolder}seismogram_obs_shot_{shot+1}_Nt{pmt.nt}_Nrec{pmt.Nrec}.bin"
seismogram = numpy.fromfile(seismogramFile, dtype=numpy.float32).reshape(pmt.nt,pmt.Nrec) 
muted_seismogram = Mute(seismogram, shot, pmt.rec_x, pmt.rec_z, pmt.shot_x, pmt.shot_z, pmt.dt, shift = 0.18,window = 0.05,v0=1500)
